...
public class veriGirisi_3 {
    public static void main(String[] args) {
        ...
        String ad;
        //2. çözüm
        // sayısal veriler String olarak okunur ve
        // ilgili veri tipine dönüştürülür
        // Double.parseDouble(giris.nextLine())
        // Integer.parseInt(giris.nextLine())

        System.out.print("Sayısal Veri Girişi:");
        d1=Double.parseDouble(giris.nextLine());

        System.out.print("Sayısal Veri Girişi:");
        d2=Double.parseDouble(giris.nextLine());

        System.out.print("Sayısal Veri Girişi:");
        sayi1=Integer.parseInt(giris.nextLine());
